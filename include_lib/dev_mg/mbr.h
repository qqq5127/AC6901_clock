...
#define MBR_DRV_MAX				16		//扫描最大的分区数
...
typedef struct _MBR_FS {
    u32(*disk_read)(void *hdev, void *buf, u32 lba);		/* device read function */
    u32(*disk_write)(void *hdev, void *buf, u32 lba);		/* device write function */
    void 	*hdev;
