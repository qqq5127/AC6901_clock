...
//类型声明区
typedef struct _TIME_LABEL { /*时间标签信息*/
...
typedef struct __LRC_FILE_IO {
    u32(*seek)(_FIL_HDL *hdl, u8 type, u32 offsize);
    u32(*read)(_FIL_HDL *hdl, u8 _xdata *buff, u16 len);
} LRC_FILE_IO;
...
extern bool lrc_show(u16 dbtime_s, u8 btime_100ms);
