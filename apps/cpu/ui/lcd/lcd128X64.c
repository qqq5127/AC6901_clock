...
#if 0
    vm_read(VM_CONTRAST, &lcd_contrast, VM_CONTRAST_LEN);
    if ((lcd_contrast > LCD_MAX_CONTRAST)  || (lcd_contrast < LCD_MIN_CONTRAST)) {
        lcd_contrast = 35;
        vm_write(VM_CONTRAST, &lcd_contrast, VM_CONTRAST_LEN);
    }
