...
@rem 文件下载列表
isd_download.exe -tonorflash -dev br21 -boot 0x2000 -div6 -wait 300  -f uboot.boot sdk.app bt_cfg.bin  bt.mp3 music.mp3 linein.mp3 radio.mp3  connect.mp3 disconnect.mp3 ring.mp3 power_off.mp3 alarmbell.mp3 rtc.mp3 vol_maxmin.mp3 -key 019_AC690X_9B99.key
