...
const u16 task_rec_ad_table[4][KEY_REG_AD_MAX] = {
    /*短按*/	    {ADKEY_ENC_SHORT},
    /*长按*/		{ADKEY_ENC_LONG},
    /*连按*/		{ADKEY_ENC_HOLD},
...
const u16 task_rec_io_table[4][KEY_REG_IO_MAX] = {
    /*短按*/	    {IOKEY_ENC_SHORT},
    /*长按*/		{IOKEY_ENC_LONG},
    /*连按*/		{IOKEY_ENC_HOLD},
...
#define IRFF00_ENC_KEY_LONG_UP 		\
								...
								/*19*/    NO_MSG,\
								/*20*/    NO_MSG
const u16 task_rec_ir_table[4][KEY_REG_IR_MAX] = {
...
const u16 task_rec_touch_table[4][KEY_REG_TOUCH_MAX] = {
...
const KEY_REG task_rec_key = {
#if (KEY_AD_RTCVDD_EN||KEY_AD_VDDIO_EN)
    ._ad = task_rec_ad_table,
#endif
#if KEY_IO_EN
    ._io = task_rec_io_table,
#endif
#if KEY_IR_EN
    ._ir = task_rec_ir_table,
#endif
#if KEY_TCH_EN
    ._touch = task_rec_touch_table,
#endif
#if KEY_UART_EN
    ._uart = task_rec_io_table,
#endif
};
